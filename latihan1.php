...
// mengambil dan membaca file json yang tersedia
$data = file_get_contents('data/pizza.json');
// kode untuk mengubah data dari json menjadi array assosiative, kode array assosiative ialah true, dan jika objek maka false
$menu = json_decode($data, true);

// berguna untuk skip membaca nama objeknya
$menu = $menu["menu"];
